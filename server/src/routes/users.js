...
router.post('/verify', parse.json, validateBody.user.verifyEmail, ctrl.users.verifyEmail);
...
router.post('/feedback', parse.urlencoded, validateBody.user.sendFeedback, ctrl.users.sendFeedback);
